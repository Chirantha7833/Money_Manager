...
<body class="bg-[#1a1a1a] text-white p-10 text-center">
    <h1 class="text-[50px] font-bold mb-10">Make Expenditure</h1>

    <form action="{{ url('/make-expenditure') }}" method="post" class="bg-black rounded-[20px] h-[420px] w-[500px] text-center mx-auto">
        @csrf 
        <div class="flex">
